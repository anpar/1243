...
veuillez vous référer aux figure \ref{pfd}, \ref{pid1} et \ref{pid2}.} 
...
\begin{figure}[htb!]
	\centering
	\rotatebox{90}{\includegraphics[scale=0.8]{media/pfd1.png}}
	\label{pdf1}
\end{figure}
\newpage
...
\begin{figure}[htb!]
	\centering
	\rotatebox{90}{\includegraphics[scale=0.8]{media/pid1.png}}
	\label{pid1}
\end{figure}
\newpage
...
\begin{figure}[htb!]
	\centering
	\rotatebox{90}{\includegraphics[scale=0.8]{media/pid2.png}}
	\label{pid2}
\end{figure}
