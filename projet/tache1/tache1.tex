...
une température $T$.
Un interface graphique est mis à votre disposition pour une utilisation plus aisée de notre outil de gestion. 
...
"OutilDeGestionGraphicalUserInterface" dans l'EDU Matlab ouvrira automatiquement le bon fichier). 
