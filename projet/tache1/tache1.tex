...
lui demander de calculer la quantité de \chemform{CO_2} rejetée dans l'atmosphère afin
...
% A refaire et à intéger dans l'outil de gestion
...
\begin{figure}[htb!]
	\centering
	\rotatebox{90}{\includegraphics[scale=0.40]{flow-sheet.png}}
...
\lstinputlisting{OutilDeGestionV2.m}
\lstinputlisting{ComputeK1.m}
\lstinputlisting{ComputeK2.m}
\end{document}