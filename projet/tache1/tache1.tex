...
On pose le flux de \chemform{NH_3(g)} à la sortie égal à $\unit{a}{\ton\per\dday}$. 
...
Et :
$$n_{O_2}= n_{air} \cdot \frac{21}{100} = \unit{\frac{7a}{884}}{\mole}$$
$$n_{Ar}= n_{air} \cdot \frac{1}{100} = \unit{\frac{1a}{2652}}{\mole}$$
...
$$n_{CH_4} = 2 \cdot n_{O_2} = \unit{\frac{7a}{442}}{\mole}$$
