...
\Delta H1 = \unit{225.99}{\kilo\joule} par mole de \chemform{CH_{4}} qui réagit, par seconde.
\Delta H2 = \unit{-36.25}{\kilo\joule} par mole de \chemform{CO} qui réagit, par seconde.
...
Q = \Delta H1*n_{\ce{CH4}} +\Delta H2*n_{\ce{CO}} = 225,99*n_{\ce{CH4}} - 36,250*n_{\ce{CO}}
(où Q est en kJ/s)
...
du débit molaire de \ce{H2O} entrant
