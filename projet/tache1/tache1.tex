...
On pose le flux de $ \chemform{NH_3(g)} $ à la sortie $= \unit{a}{\ton\per\dday} $ 
...
$$ m_{\chemform{NH_3}}= \unit{a}{\ton\per\dday} $$ 

Et donc, 
 
$$ n_{\chemform{NH_3}}= \unit{frac{a}{17}} {\mol} $$

Ce qui donne 

$$ n_{\chemform{N_2}}=\frac{n_{\chemform{NH_3}}}{2} = \unit{\frac{a}{34}} {\mol} $$ 

et 

$$ n_{\chemform{H_2}}= \frac{3}{2} * n_{\chemform{NH_3}} $$

On sait que le \chemform{N_2(g)} provient uniquement de l'air entrant dans le réacteur du  réformage primaire.

Et comme on peut considérer que l'air est composé de 78% de \chemform{N_2(g)}, 21% de \chemform{O_2(g)} et 1% d'\chemform{Ar(g)}, 

on peut déduire que $$n_{air}$$ entrant dans le réacteur du réformage primaire vaut : 

$$n_{air}= n_{\chemform{N_2}}*\frac{100}{78} = \unit{\frac{25a}{663}}{\mol} $$ 
 Et :
$$n_{\chemform{0_2}}= n_{air}*\frac{21}{100} = \unit{\frac{28a}{221}}{\mol}$$

$$n_{\chemform{Ar}}= n_{air}*\frac{1}{100} = \unit{\frac{10a}{663}}{\mol}$$

On sait par la réaction du réformage primaire suivante et par l'hypothèse que le \chemform{CH_4(g)} et le \chemform{O_2(g)} sont présents en quantité stoechiométrique : 
...
$$n_{\chemform{CH_4}} = 2n_{\chemform{O_2}}= \unit{\frac{7a}{442}}{\mol}$$
$$n_{\chemform{CO}} = n_{\chemform{CH_4}}=  \unit{\frac{7a}{442}} {\mol}$$
$$n_{\chemform{H_2}} = 2*n_{\chemform{CH_4}}=  \unit{\frac{7a}{221}}{\mol}$$

On s'intéresse ensuite à la réaction du Water-Gas-Shift.

On sait que $n_{\chemform{CO}} = n_{\chemform{CO}}$ produit au réformage primaire $+ n_{\chemform{CO}}$ produit au réfomarge secondaire. 

Et donc on a : 

$$n_{\chemform{C0_2}} = n_{\chemform{CO}} = n_{\chemform{H_2O}}$$

S'il reste du \chemform{H_20} à la fin de cette réaction, $n_{\chemform{H2_0}}$ sera égal à $n_{\chemform{H2_O}}$ du réformage primaire moins le $n_{\chemform{CO}} $  du WGS.

On peut aussi déduire que $n_{\chemform{CO_2}-tot} = n_{\chemform{CO_2}-réformage primaire} + n_{\chemform{CO_2}-WGS}$.

On peut aussi conclure que : 

$$n_{\chemform{H_2}-réformage primaire}= n_{\chemform{H_2}-synthèse \chemform{NH_3}} - n_{\chemform{H_2}-réformarge secondaire} - n_{\chemform{H_2}-WGS}$$

Après la résolution de l'équilibre du réformage primaire, 
on obtient les valeurs suivantes : 

$$ n_{\chemform{H_2O}-réformage primaire} = $$
$$ n_{\chemform{CO}-réformage primaire} = $$
$$ n_{\chemform{CO_2}-réformage primaire} = $$
$$ n_{\chemform{H_2}-réformage primaire} = $$

$$ n_{\chemform{CO}-WGS} = $$
$$ n_{\chemform{CO2}-WGS} = $$
$$ n_{\chemform{H_2}-WGS} = $$

$$ n_{\chemform{CO_2}-final} =$$ 
$$ n_{\chemform{H_2O}-final} = $$
