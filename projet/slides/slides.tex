...
\begin{document} 
	...
	\begin{frame}
		...
		\begin{itemize}
			\item Séparation : \unit{625774.25}{\ton\per\year} ;
			\item Combustion : \unit{83220}{\ton\per\year} ;
			\item \textbf{Total} : \unit{710217}{\ton\per\year}.
		\end{itemize}
		% Citer la source de Pauline
	...
	\frametitle{Références}
		...
		\bibliography{../tache4/sources-tache4,../tache8/sources-tache8}
		\nocite{*}
	\end{frame}
