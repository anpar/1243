...
Dans le cadre du projet P3, nous avons réalisé une étude théorique sur la fabrication
...
réaction Haber-Bosch ait lieu, la source des réactifs utilisés ainsi que l'énergie nécessaire au réformage 
primaire.
...
d'ammoniac correspondant à nos produits disponibles, et nous finissons par un calcul du nombre de tubes nécessaires à un 
...
le nombre de moles de \ce{CO} a l'entrée de la réaction Water-Gas-Shift,
...
% Attention il y a une contradiction dans la définition des indices ici. Il est écrit ici que
% WGS en indice signifie à la SORTIE du WGS. Plus haut il est indiqué que cela correspond à
% l'entrée.
