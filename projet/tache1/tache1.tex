...
% Insèrer le code MatLab coloré, commenté, avec ligne numérotée.
% Critiquez le code MatLab, proposer des améliorations, etc.
...
$\frac{R}{\frac{16\cdot x_{CH_{4}}+18\cdot x_{H_{2}O}}{2}}}$ ($x_{CH_{4}$ et $x_{H_{2}O}$ sont les fractions molaire du méthane
et de l'eau entrant dans le système). Ensuite, à l'aide des notions de système ouvert et de l'hypothèse $\dot{m_{entrée}} = \dot{m_{sortie}}$,
