...
\begin{document} 
	...
	\begin{itemize}
		...
		\item Chauffer le réacteur du reformage primaire avec une source d'énergie verte ;
	...
	\begin{frame}
		...
		\fbox{\begin{minipage}{0.9\textwidth}Avec \unit{246}{\hectare} d'algues, on produit \unit{35084754}{\liter}
		de biodiesel par an et on recycle \unit{338}{\ton} de \chemform{CO_2} par an. C'est à dire 11.7\% 
	...
	\begin{frame}
		...
		\begin{itemize}
			\item Les coûts de production varient de 0.5 à 6 euros ;
			\item Le prix de revient de l'algocarburant est d'environ 5 euros le litre \cite{PrixAlgues}.
		\end{itemize}
		Le coût de production est encore trop élevé en comptant les différentes
		étapes de raffinage. 
	
		Nécessité de continuer le R\&D sur les algocarburants.
	\end{frame}
