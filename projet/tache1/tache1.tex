...
\paragraph{Cas 1 : on considère les capacités calorifiques constantes}
...
En connaissant la capacité calorifique de l'eau $C_{H_2O(g)} = \unit{4185.5}{\joule\per\kilo\gram\kelvin}$ et en égalant
