...
et $p_0$ est la pression standard, c'est à dire \unit{1}{\bbar}.
...
Le Water Gas Shift s'opere generalement entre 200 et \unit{400}{\degreecelsius}. Nous considérerons %% on peut mettre le 200 en unit ?
...
(où $Q$ est en kJ/s) %ca beug dans pdf dans la parenthèse mais pourtant le code à l'air correct, et pareil pour l'équation il y des asterix degeu
...
composants à chaque étape du procédé. Les résultats sont présentés en tonnes par jour
...
avec lequel les calculs \textbf{ne fonctionneront pas} si on l'ouvre directement). Taper ensuite simplement
...
\chemform{NH_3} requis et la température du réacteur du réformage primaire.
