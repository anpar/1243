...
%\begin{figure}[ht] % souci à la compilation
	%\centering
	%\begin{subfigure}[b]{0.45\textwidth}
	%	\includegraphics[scale=0.8]{circuit-antenne.png}
	%	\caption{Circuit d'une antenne}
	%	
	%\end{subfigure}
	%\begin{subfigure}[b]{0.45\textwidth}
	%	\includegraphics[scale=0.8]{circuit-antenne-2.png}
	%\caption{}	
	%
	%\end{subfigure}
	%
...
%\begin{figure}[ht!]  % souci compilation
 %     \centering  
  %  \includegraphics[scale=0.75]{antenne.png}  
...
$$\frac{P}{S}=I=\epsilon_0 \cdot c \cdot E^2 $$\\ % desolé Antoine...
